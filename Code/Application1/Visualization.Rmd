...
```{r}
h.est <- read.csv(file = "~/Github/Workshop_DGfS2022/Results/Application1/entropy_ML.csv")
head(h.est)
h.neural.est <- read.csv(file = "~/Github/Workshop_DGfS2022/Results/Application1/entropy_NeuralNet.csv")
head(h.neural.est)
```
