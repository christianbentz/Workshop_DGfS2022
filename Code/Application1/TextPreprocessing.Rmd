...
file.list <- list.files(path = "~/Github/Workshop_DGfS2022/Data/Application1/original", 
...
for (file in file.list) { 
  ...
  output.file <- paste("~/Github/Workshop_DGfS2022/Data/Application1/processed/", filename, sep = "")
